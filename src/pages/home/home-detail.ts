...
export class HomeDetailPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public socialSharing: SocialSharing, public sanitize:DomSanitizer, public topicService: TopicService, public collectService: CollectService, public repliesService: RepliesService, public utilService: UtilService) {
