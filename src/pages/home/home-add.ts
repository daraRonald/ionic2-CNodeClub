...
export class HomeAddPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public events: Events, public topicService: TopicService, public utilService: UtilService) {
    this.topicParams = {
      accesstoken: '',
      tab: '',
      title: '',
