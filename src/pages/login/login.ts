...
export class LoginPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public viewCtrl: ViewController, public storage: Storage, public events: Events, public appVersion: AppVersion, public barcodeScanner: BarcodeScanner, public userService: UserService, public utilService: UtilService) {
    this.user = {
      loginname: '',
      avatar_url: '',
      accesstoken: ''
