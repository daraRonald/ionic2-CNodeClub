...
export class AccountMessagesPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public events: Events, public badge: Badge, public messageService: MessageService, public utilService: UtilService) {
    this.messageParams = {
      mdrender: true,
      accesstoken: ''
    }
