...
export class AccountPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public events: Events, public appVersion: AppVersion, public badge: Badge, public storage: Storage, public userService: UserService, public utilService: UtilService, public messageService: MessageService) {
    this.user = {
      avatar_url: '',
      loginname: '',
      score: '',
